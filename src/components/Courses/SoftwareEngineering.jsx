...
const SoftwareEngineering = () => {
    return (
        <div className='mt-10 flex flex-col gap-3'>
            ...
            <p className='font-bold text-2xl'>Content will be updated soon...</p>
        </div>
    );
};
