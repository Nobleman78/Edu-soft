...
const Searchbar = ({data}) => {
    ...
    return (
        <form onSubmit={onSearchHandler} className='flex items-center justify-between border py-3  border-gray-500/20 rounded w-80 mt-3 md:w-[50%] mx-auto relative bg-white '>
