    ...
    return (
        <div className='mt-20  '>
            <div className='flex flex-col md:flex-row justify-between gap-20'>
                ...
                <span className='md:w-[33%] relative bg-[#20B486]  h-100 rounded-[50%]'> <img className='h-80 lg:h-85 xl:h-90 left-4.5   top-5 md:h-85  absolute md:left-0 xl:left-15 md:top-1 ' src={heroImage} alt="" /></span>
            </div>
            <Searchbar/>
        </div>
    );
